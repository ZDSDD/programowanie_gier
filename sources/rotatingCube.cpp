...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        MV = glm::rotate(MV, CurrentTime, glm::vec3(0.0f, 1.0f, 0.0f));
        glm::mat4 Proj = glm::perspective(glm::radians(45.0f), (float)SCREEN_WIDTH/(float)SCREEN_HEIGHT, 0.01f, 100.0f);
