...
//shaders
const std::string vertexShader = readShaderSourceFromFile("vertexShaderSource.vertexshader").c_str();

const GLchar* vertexShaderSource = vertexShader.c_str();

const std::string fragmentShader = readShaderSourceFromFile("fragmentShaderSource.fragmentshader");
